...
ALLOWED_HOSTS = ["storage.eventshock.ru", "api.eventshock.ru", "127.0.0.1"]
...
# Eventshock Storage Auth settings
...
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8000', 'http://localhost:8000', 'https://storage.eventshock.ru']
